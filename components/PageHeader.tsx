export default () => (
  <header className="text-gray-600 body-font sticky top-0 bg-white z-10 backdrop-blur-lg bg-opacity-80">
    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      <button className="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Můj Hamham
