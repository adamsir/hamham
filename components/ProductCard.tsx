...
export default (content: Product) => (
  <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
    <div className="border-2 p-4">
      ...
      <div className="mt-4">
        <button className="inline-flex items-center border-2 border-gray-700 py-1 px-3 hover:bg-gray-200 rounded text-base font-semibold text-black mt-4 md:mt-0">Do bříška</button>
      </div>
    </div>
  </div>
)